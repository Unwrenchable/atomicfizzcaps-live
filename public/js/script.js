...
// Moved setStatus ABOVE initMap to fix "not defined" error
...
// Loot claim + random battle trigger
...
async function triggerRandomBattle(location) {
    ...
    document.getElementById('mintMsg').innerHTML = `Raiders at ${location}<br>Your Gear PWR: ${gearPower}`;
...
// Map init — now calls setStatus safely
